...
export const images = {
	...
	/** Contacto section: soft nature background */
...
export const photoCredits = [
	...
	{
		label: "Sección problema / comida",
		url: UNSPLASH_PHOTO("1494597564530-871f2b93ac55"),
	},
	{
		label: "Solución (espacio seguro)",
		url: UNSPLASH_PHOTO("1507003211169-0a1dd7228f2d"),
	},
	{
		label: "Solución (mindfulness)",
		url: UNSPLASH_PHOTO("1545205597-3d9d02c29597"),
	},
	{
		label: "Cómo trabajamos",
		url: UNSPLASH_PHOTO("1573496359142-b8d87734a5a2"),
	},
	{
		label: "Testimonios (avatar 1)",
		url: UNSPLASH_PHOTO("1531746020798-e6953c6e8e04"),
	},
	{
		label: "Testimonios (avatar 2)",
		url: UNSPLASH_PHOTO("1529626455594-4ff0802cf2fb"),
	},
	{
		label: "Testimonios (avatar 3)",
		url: UNSPLASH_PHOTO("1517841905240-472988babdf9"),
	},
	{
		label: "CTA (fondo naturaleza)",
		url: UNSPLASH_PHOTO("1506905925346-21bda4d32df4"),
	},
] as const;
