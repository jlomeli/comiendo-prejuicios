		...
		>
			...
			<ScrollReveal>
				<div className="max-w-3xl mx-auto text-center p-10 sm:p-14 rounded-[2rem] bg-card/90 backdrop-blur-sm border border-primary/20 shadow-lg">
					<h2
						id="cta-heading"
						className="font-serif text-3xl sm:text-4xl md:text-5xl font-semibold text-foreground mb-4"
					>
						¿Lista para dar el primer paso?
					</h2>
					<p className="text-muted-foreground text-lg mb-8">
						La consulta gratuita es un espacio para conocernos y ver si este
						proceso es para ti. Sin compromiso.
					</p>
					<motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.98 }}>
						...
						>
							<a href={CONSULTATION_URL}>Agendar mi consulta gratuita</a>
						</Button>
					</motion.div>
				</div>
			</ScrollReveal>
