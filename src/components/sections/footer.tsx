    ...
    >
      <div className="max-w-5xl mx-auto">
        <ScrollReveal className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
          <div>
            <p className="font-serif font-semibold text-foreground text-lg">Comiendo Prejuicios</p>
            <p className="text-sm text-muted-foreground mt-1">
              Terapia · CBT · Trastornos alimentarios · Trauma · Espacios neurodivergente-friendly
            </p>
          </div>
        ...
        <ScrollReveal className="mt-10 pt-8 border-t border-border/60">
          <p className="text-sm font-medium text-foreground mb-2">Créditos fotográficos</p>
          <p className="text-sm text-muted-foreground mb-3">
            ...
            . Cada enlace lleva a la foto en Unsplash, donde se muestra el autor.
          </p>
